...
class RTLGenerator:
    ...
    def generate_dynamic_isles(self):
        ...
        # DELIBERATELY NO FALLBACK: a written width and a guessed one are
        # indistinguishable in the generated files (a guess can match the fleet
        # by coincidence and hide for weeks), so a pass that cannot produce the
        # real number must stop the generation, not guess.
    ...
    def render_top_level(self, comp_info, wiring_matrix, global_defines):
        ...
        template_kwargs = {
            ...
            # power cycle fights the bench: on a force-mode project the cycle-1
    ...
    def generate_verilator_config(self, cfg_dir, hw_dir, top_level_module_name, comp_info=None):
        ...
        # dividend the force-free bring-up exists for.
        ...
        # LOCAL EXCLUSIONS VS EXPORTED DECLARATIONS.
