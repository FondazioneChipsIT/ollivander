<%
  ...
  # Determine RouteCfg based on multicast feature
  route_cfg = "RouteCfg" if comp.features and comp.features.get('multicast_target') else "RouteCfgNoMcast"
...
% if is_host and config.system_controller:
  ...
  output ${p_name}_reg2hw_t sys_regs_reg2hw_o,
  input  ${p_name}_hw2reg_t sys_regs_hw2reg_i
% endif
);
...
% endif
  ...
  // 1. FLOONOC ROUTER
  // =======================================================================
  // Eject port connects to the Chimney. Cardinal ports connect outside.
