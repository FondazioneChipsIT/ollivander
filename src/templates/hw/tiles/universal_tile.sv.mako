...
(
  ...
  input wire floo_${p_name}_noc_pkg::id_t  id_i,
  ...
  input wire floo_${p_name}_noc_pkg::floo_rsp_t  [West:North] floo_rsp_i,
  output floo_${p_name}_noc_pkg::floo_wide_t [West:North] floo_wide_o,
  input wire floo_${p_name}_noc_pkg::floo_req_t  [West:North] floo_req_i,
  output floo_${p_name}_noc_pkg::floo_rsp_t  [West:North] floo_rsp_o,
  input wire floo_${p_name}_noc_pkg::floo_wide_t [West:North] floo_wide_i
...
% if use_mcast:
    .RouteAlgo     ( floo_${p_name}_noc_pkg::RouteCfg.RouteAlgo ),
% else:
...
% if use_mcast:
    .RouteCfg            ( floo_${p_name}_noc_pkg::RouteCfg ),
% else:
...
% if use_join:
  <%
    ...
    if noc_mode == "joined_narrow":
        c_data_width = f"floo_{p_name}_noc_pkg::AxiCfgN.DataWidth"
    elif noc_mode == "joined_wide":
        c_data_width = f"floo_{p_name}_noc_pkg::AxiCfgW.DataWidth"
  ...
  localparam floo_pkg::axi_cfg_t AxiCfgJoin = '{
    AddrWidth:  floo_${p_name}_noc_pkg::AxiCfgN.AddrWidth,
    DataWidth:  ${c_data_width},
    UserWidth:  floo_pkg::max(floo_${p_name}_noc_pkg::AxiCfgN.UserWidth, floo_${p_name}_noc_pkg::AxiCfgW.UserWidth),
    InIdWidth:  floo_pkg::max(floo_${p_name}_noc_pkg::AxiCfgN.OutIdWidth, floo_${p_name}_noc_pkg::AxiCfgW.OutIdWidth),
    OutIdWidth: floo_pkg::max(floo_${p_name}_noc_pkg::AxiCfgN.OutIdWidth, floo_${p_name}_noc_pkg::AxiCfgW.OutIdWidth) + 1
  };
  % else:
