...
// It generates a complete protocol conversion pipeline: 
// Async AXI4 (64-bit) -> Sync AXI4 -> AXI4 Atomics -> AXI4 (32-bit) -> 
// AXI-Lite -> APB. It then instantiates and maps all nested peripherals.
//
// BENDER: name="axi"
// BENDER: name="apb"
...
% for p in _apb_periphs:
 ...
 % elif p['type'] == 'aon_timer':
  ...
  // ${p['name']} 
  // This is an OpenTitan IP. It requires a conversion from APB -> RegBus -> TileLink-UL (TL-UL).
  typedef struct packed {
