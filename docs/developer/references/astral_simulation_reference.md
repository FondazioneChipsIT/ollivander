...
- Message policy: `-permissive -suppress 3009 -suppress 8386 -error 7 +nospecify -sdfnoerror -suppress 1565 -suppress 13271` - the last four self-described in a comment as a workaround "to enable simulations with Thales IP". Compare Ollivander's per-message documented suppression table in the generated sim/sim.mk.
