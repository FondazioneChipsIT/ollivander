...
//
// Vendored UNMODIFIED into Ollivander from cheshire's target/sim/src/elfloader.cpp
// (upstream pulp-platform/cheshire, Apache-2.0 as stated above). It provides the
// read_elf / get_section / read_section / get_entry DPI surface the generated
// testbench uses when a preload memory declares 'image: elf'; both simulator
// flows compile it unconditionally so the DPI imports never dangle.
